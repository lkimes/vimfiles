...
"                               加入HDL_Generic_For_Debussy()函数，可将testbench配合Debussy使用。
"                               快速添加相应的代码到testbench文件中。
"
"
"
"
...
nmap <silent> <unique> <F12> :ModSimComp<CR><CR>
...
"                 对VHDL文件，需要先将novas.vhd编译，并添加novas库到modelsim的默认库中
"                 for example
